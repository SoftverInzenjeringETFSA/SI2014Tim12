...
public class KorisnikTest {
	...
	public void test() {
		...
		try{
			...
			assertEquals("Id materijala mora biti jednak novom id-u", novi_id, k.getId());
			...
			assertEquals("Username moraju biti jednaki", k.getUsername(), novi.getUsername());
			assertEquals("Passwordi moraju biti jednaki", 
					k.getPassword(), novi.getPassword());
